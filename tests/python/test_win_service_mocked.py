...
class TestMockedWinService(unittest.TestCase):
    ...
    def test_service_lifecycle(self, mock_runner_class):
        ...
        with patch("threading.Thread") as mock_thread_class:
            ...
            self.mock_win32event.WaitForSingleObject.assert_called_with(
                svc.stop_event, self.mock_win32event.INFINITE
            )
    ...
    def test_main_when_win32_available(self):
        ...
        self.mock_win32serviceutil.HandleCommandLine.assert_called_once_with(
            captivity.daemon.win_service.CaptivityService
        )
